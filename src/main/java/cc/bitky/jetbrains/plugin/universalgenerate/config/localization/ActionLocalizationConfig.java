...
public class ActionLocalizationConfig {
    ...
    static {
        ...
        INTENTION_FAMILY_MAP.put(IntentionFamilyEnum.SEARCH_ELEMENT_NAME_TO_JAVA_DOC, SEARCH_ELEMENT_NAME_TO_JAVA_DOC);
        INTENTION_FAMILY_MAP.put(IntentionFamilyEnum.SWAGGER_TO_JAVA_DOC, ANNOTATION_TO_JAVA_DOC);
        INTENTION_FAMILY_MAP.put(IntentionFamilyEnum.GENERATE_ANNOTATION, GENERATE_ENTRY_ANNOTATION);
        INTENTION_FAMILY_MAP.put(IntentionFamilyEnum.DELETE_ELEMENT, DELETE_ELEMENT);
    }
