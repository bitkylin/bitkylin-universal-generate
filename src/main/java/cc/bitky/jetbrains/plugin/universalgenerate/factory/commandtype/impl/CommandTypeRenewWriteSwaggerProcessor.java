 ...
 * @author bitkylin
 */
public class CommandTypeRenewWriteSwaggerProcessor implements ICommandTypeProcessor {

    private final WriteContext writeContext;

    public CommandTypeRenewWriteSwaggerProcessor(WriteContext writeContext) {
