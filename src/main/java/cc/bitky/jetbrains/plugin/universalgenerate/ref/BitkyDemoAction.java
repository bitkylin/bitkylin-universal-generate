package cc.bitky.jetbrains.plugin.universalgenerate.ref;

import cc.bitky.jetbrains.plugin.universalgenerate.ref.utils.GeneratorUtils;
 ...
 * @date 2020/4/5
 */
public class BitkyDemoAction extends AnAction {
