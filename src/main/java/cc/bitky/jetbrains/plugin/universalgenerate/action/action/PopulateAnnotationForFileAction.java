 ...
 */
@Slf4j
public class PopulateAnnotationForFileAction extends AbstractUniversalGenerateAction {

    public PopulateAnnotationForFileAction(String text) {
        super(text);
    }

    public PopulateAnnotationForFileAction() {
        super();
    }
