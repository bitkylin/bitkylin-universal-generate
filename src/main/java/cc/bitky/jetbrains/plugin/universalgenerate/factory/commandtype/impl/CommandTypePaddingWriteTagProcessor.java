 ...
 * @author bitkylin
 */
public class CommandTypePaddingWriteTagProcessor extends CommandTypeAbstractWriteTagProcessor implements ICommandTypeProcessor {

    public CommandTypePaddingWriteTagProcessor(WriteContext writeContext, AnnotationTagConfig annotationTagConfig) {
